      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.inlineInputContainer}>
          <View style={[styles.inputContainer, styles.inlineInput]}>
            <Label style={styles.title} htmlFor="time">Budget</Label>
            <Input style={[styles.input, styles.inputTime]} size="$4" borderWidth={2} />
          </View>
          <View style={[styles.inputContainer, styles.inlineInput]}>
            <Label style={styles.title2}htmlFor="director">Minutes</Label>
            <Input style={[styles.input, styles.inputDirector]} size="$4" borderWidth={2} />
          </View>
        </View>
      </View>
      <Button style={{backgroundColor:"#000000", color:"white", borderColor:"white",marginTop:50}}>Create Scene</Button>
